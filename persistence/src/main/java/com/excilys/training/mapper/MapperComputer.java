...
public class MapperComputer {
    ...
    public ComputerDTO ObjToDTO(Computer computer) {
        ...
        computerDTO
                .setIntroduced((computer.getIntroduced() != null) ? computer.getIntroduced().format(formatter) : null);
    ...
    public Computer DTOToObj(ComputerDTO computerDTO) {
        ...
        computer = new Computer.Builder(name).id(id).introduced(introduced).discontinued(discontinued).company(company)
                .build();
        return computer;
    }
}
